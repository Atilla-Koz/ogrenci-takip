...
export default function AdminPanel() {
  ...
  const TeacherCard = ({ teacher }) => (
    <div
      ...
      className="group relative bg-white dark:bg-gray-800 rounded-xl shadow-sm hover:shadow-lg transition-all duration-200 overflow-hidden border border-purple-100 dark:border-purple-900/50 cursor-pointer"
    >
